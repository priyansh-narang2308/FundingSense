...
class Generator:
    ...
    async def generate_report(
        ...
        system_prompt = (
            ...
            f"0. You MUST write the ENTIRE REPORT in the following language: {language}. This includes keys like 'executive_summary', 'why_this_fits', 'why_this_does_not_fit', 'reasons', and 'focus_areas'.\n"
